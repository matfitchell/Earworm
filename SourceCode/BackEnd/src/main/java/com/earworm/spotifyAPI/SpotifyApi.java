package com.earworm.spotifyAPI;

import com.google.gson.JsonArray;
import com.neovisionaries.i18n.CountryCode;
import com.earworm.spotifyAPI.enums.ModelObjectType;
import com.earworm.spotifyAPI.model_objects.specification.Artist;
import com.earworm.spotifyAPI.model_objects.specification.Track;
import com.earworm.spotifyAPI.requests.authorization.authorization_code.AuthorizationCodeRefreshRequest;
import com.earworm.spotifyAPI.requests.authorization.authorization_code.AuthorizationCodeRequest;
import com.earworm.spotifyAPI.requests.authorization.authorization_code.AuthorizationCodeUriRequest;
import com.earworm.spotifyAPI.requests.authorization.authorization_code.pkce.AuthorizationCodePKCERefreshRequest;
import com.earworm.spotifyAPI.requests.authorization.authorization_code.pkce.AuthorizationCodePKCERequest;
import com.earworm.spotifyAPI.requests.authorization.client_credentials.ClientCredentialsRequest;
import com.earworm.spotifyAPI.requests.data.albums.GetAlbumRequest;
import com.earworm.spotifyAPI.requests.data.albums.GetAlbumsTracksRequest;
import com.earworm.spotifyAPI.requests.data.albums.GetSeveralAlbumsRequest;
import com.earworm.spotifyAPI.requests.data.artists.*;
import com.earworm.spotifyAPI.requests.data.browse.*;
import com.earworm.spotifyAPI.requests.data.browse.miscellaneous.GetAvailableGenreSeedsRequest;
import com.earworm.spotifyAPI.requests.data.episodes.GetEpisodeRequest;
import com.earworm.spotifyAPI.requests.data.episodes.GetSeveralEpisodesRequest;
import com.earworm.spotifyAPI.requests.data.follow.*;
import com.earworm.spotifyAPI.requests.data.follow.legacy.FollowPlaylistRequest;
import com.earworm.spotifyAPI.requests.data.follow.legacy.UnfollowPlaylistRequest;
import com.earworm.spotifyAPI.requests.data.library.*;
import com.earworm.spotifyAPI.requests.data.personalization.GetUsersTopArtistsAndTracksRequest;
import com.earworm.spotifyAPI.requests.data.personalization.interfaces.IArtistTrackModelObject;
import com.earworm.spotifyAPI.requests.data.personalization.simplified.GetUsersTopArtistsRequest;
import com.earworm.spotifyAPI.requests.data.personalization.simplified.GetUsersTopTracksRequest;
import com.earworm.spotifyAPI.requests.data.player.*;
import com.earworm.spotifyAPI.requests.data.playlists.*;
import com.earworm.spotifyAPI.requests.data.search.SearchItemRequest;
import com.earworm.spotifyAPI.requests.data.search.simplified.*;
import com.earworm.spotifyAPI.requests.data.search.simplified.special.SearchAlbumsSpecialRequest;
import com.earworm.spotifyAPI.requests.data.shows.GetSeveralShowsRequest;
import com.earworm.spotifyAPI.requests.data.shows.GetShowRequest;
import com.earworm.spotifyAPI.requests.data.shows.GetShowsEpisodesRequest;
import com.earworm.spotifyAPI.requests.data.tracks.*;
import com.earworm.spotifyAPI.requests.data.users_profile.GetCurrentUsersProfileRequest;
import com.earworm.spotifyAPI.requests.data.users_profile.GetUsersProfileRequest;
...
public class SpotifyApi {
   ...
   * @see <a href="https://developer.spotify.com/web-api/user-guide/#spotify-uris-and-ids">Spotify: URLs &amp; IDs</a>
   */
  public com.earworm.spotifyAPI.requests.data.follow.FollowPlaylistRequest.Builder followPlaylist(String playlist_id, boolean public_) {
    return new com.earworm.spotifyAPI.requests.data.follow.FollowPlaylistRequest.Builder(accessToken)
      .setDefaults(httpManager, scheme, host, port)
      .playlist_id(playlist_id)
      .public_(public_);
  }
   ...
   *
   * @param playlist_id The playlist's ID.
   * @return An {@link com.earworm.spotifyAPI.requests.data.follow.UnfollowPlaylistRequest.Builder}.
   * @see <a href="https://developer.spotify.com/web-api/user-guide/#spotify-uris-and-ids">Spotify: URLs &amp; IDs</a>
   */
  public com.earworm.spotifyAPI.requests.data.follow.UnfollowPlaylistRequest.Builder unfollowPlaylist(String playlist_id) {
    return new com.earworm.spotifyAPI.requests.data.follow.UnfollowPlaylistRequest.Builder(accessToken)
      .setDefaults(httpManager, scheme, host, port)
      .playlist_id(playlist_id);
  }
